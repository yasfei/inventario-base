    ...
    public partial class frmConsultarProduto : Form
    {
        ...
        private void btnConsultarProduto_Click(object sender, EventArgs e)
        {
            ...
            if ((txbConsultCodigo.Text != null && txbConsultCodigo.Text.Trim() != "") && txbConsultNome.Text == null || txbConsultNome.Text.Trim() == "")
                ...
                produtosEncontrados = ProdutoCtrl.buscarProdutoDaListaPorCodigo(txbConsultCodigo.Text);
                ...
                if ((txbConsultCodigo.Text == null || txbConsultCodigo.Text.Trim() == "") && txbConsultNome.Text != null && txbConsultNome.Text.Trim() != "")
                    ...
                    produtosEncontrados = ProdutoCtrl.buscarProdutoDaListaPorNome(txbConsultNome.Text.Trim()); //PRODCURA PELO NOME
                    ...
                    if ((txbConsultCodigo.Text != null && txbConsultCodigo.Text.Trim() != "") && txbConsultNome.Text != null && txbConsultNome.Text.Trim() != "")
                        ...
                        produtosEncontrados = ProdutoCtrl.buscarProdutoDaListaPorCodigoEPorNome(txbConsultCodigo.Text, txbConsultNome.Text.Trim()); //PRODCURA PELO NOME E PELO CÓDIGO
            ...
            {
                //Encontrou
                visualizarAlterarProduto.CarregarGrid(produtosEncontrados);
                this.Close();
